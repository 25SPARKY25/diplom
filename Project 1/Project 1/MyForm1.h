...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"MyForm1";
			this->Text = L"¬ведите количество генераций";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		for (int i = 0; i < z; i++)
		{
			...
			progress->Text = ("»дЄт создание изображений. —оздано " + i.ToString() + " из " + z.ToString());
			//label6->Text = ("»дЄт обработка изображений. ќбработано " + counter.ToString() + " из " + openFileDialog1->FileNames->Length.ToString());
			//progress->label1->Text = ("»дЄт обработка изображений. ќбработано " + counter.ToString() + " из " + openFileDialog1->FileNames->Length.ToString());
			progress->progressBar1->PerformStep();
		}
		progress->Close();
		MessageBox::Show("—оздание картинок завершено");
		this->Close();
	}
	};
}
